import{i as M,d as E,w as A,u as b,Y as h}from"./iframe.db3d7f7a.js";var c="backgrounds",{document:l,window:L}=A,B=()=>L.matchMedia("(prefers-reduced-motion: reduce)").matches,H=(r,e=[],t)=>{if(r==="transparent")return"transparent";if(e.find(a=>a.value===r))return r;let n=e.find(a=>a.name===t);if(n)return n.value;if(t){let a=e.map(o=>o.name).join(", ");M.warn(E`
...
//# sourceMappingURL=preview.703c3c51.js.map
